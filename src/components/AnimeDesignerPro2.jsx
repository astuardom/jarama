...
const COLOR_MAP = {
  negro: '#1f2937',   // gris oscuro
  blanco: '#f9fafb',  // blanco
  rojo: '#dc2626',    // rojo
  azul: '#3b82f6'     // azul
};
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="flex gap-4">
              {Object.entries(TSHIRT_MOCKUPS).map(([key]) => (
                <button
                  key={key}
            ...
            <p className="text-sm text-gray-500 mt-1">Color seleccionado: <strong className="capitalize">{color}</strong></p>
          </div>
